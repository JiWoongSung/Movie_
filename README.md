...
(수정)
5. 고객은 본인의 예약 내용 및 상태를 조회한다. (CQRS 하게 되면..!)
...
(수정)
11. 고객은 본인의 예약 내용 및 상태를 조회한다. (CQRS 하게 되면..!)
...
3. 성능
  i. 고객이 재고관리에서 확인할 수 있는 도서 재고를 예약(프론트엔드)에서 확인할 수 있어야 한다. CQRS
  ii. 예약이 완료되면 카톡 등으로 알림을 줄 수 있어야 한다. Event driven
